...
const CourtCaseList = ({ account, contract, role }) => {

    // //Dealing with get cases data

    const params = useParams();
    const courtAdd = params.courtAdd;
    ...
    const getCasesAssignedToCourt = async () => {
      ...
      let countPending= 0 ;
        ...
        if (contract && account) {
            listOfCaseIds = await contract.getAllCasesAssignedToCourt(courtAdd);
            ...
            {(role == "admin") && account && contract ?
                <>
                    <div className="personalInfo">
                        <div className="left">
                            <div className="entry">
                                <div className="label">Courts Address</div>
                                <div className="value">{courtAdd}</div>
                            </div>
                            <div className="entry">
                                    ...
                                    cases.map((indiCase) => {
                                        return (
                                            <li className="caseTable-row_cases" key={indiCase.caseId}>
                                                ...
                                                <div className="col col-2" data-label="Case Owner">{indiCase.desc}</div>
